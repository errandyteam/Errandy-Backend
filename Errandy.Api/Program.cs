...
{
    options.SwaggerDoc("v1", new OpenApiInfo { Title = "Errandy API", Version = "v1" });
...
using (var scope = app.Services.CreateScope())
{
    ...
    var adminEmail = builder.Configuration["Seed:AdminEmail"] ?? "admin@errandy.com";
    var adminPassword = builder.Configuration["Seed:AdminPassword"] ?? "Admin@12345";
    await DatabaseSeeder.SeedAsync(db, hasher, adminEmail, adminPassword);
}
// ----- Pipeline -----
